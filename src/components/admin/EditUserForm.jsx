...
const EditUserForm = ({handleClose10}) => {
  ...
  return (
    <form className='relative lg:w-[100%] w-full px-5 text-white'>
        <h1 className='text-center text-4xl font-prompt mt-2'>Update User Details</h1>
        <div className='mt-2'>
        ...
        <div className='mb-3 mt-2'>
            ...
            <button className={`${USER_TYPE=="Admin"? "":"hidden"} mt-2 px-5 bg-blue-600 hover:bg-blue-800 rounded-lg`} type="button">Edit admit rights</button>
            {/* <input  ></input> */}
        </div>
        
        <div className='pb-5'>
            <button onClick={handleClose10} className='shadow-[0_0_4px_rgba(0,0,0,0.15)] w-full text-center text-2xl  bg-green-600 hover:bg-green-800 mt-5 text-white rounded-lg py-2 '>Save Changes</button>
        </div>
        ...
        <div onClick={handleClose10} className='absolute w-12 h-8 top-2 right-4 rounded-full hover:text-blue-300 cursor-pointer'>

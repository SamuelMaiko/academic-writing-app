    ...
    <div>
        <div className="card relative w-[100%] h-[23rem] rounded-lg bg-secondary border-2 border-[#c3c6ce] transition-all duration-500  hover:border-btlinks shadow-[0_0_4px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_18px_0_rgba(0,0,0,0.25)] cursor-pointer">
            <div className="card-details text-black h-full overflow-y-scroll"> 
                <p className=" md:text-[1.5rem] text-[1.3rem] font-normal font-opensans text-tcolor"><span className="font-semibold text-black underline">Title:</span> Discuss the impact of Technology on education. Discuss the impact of Technology on education. </p>
            ...
            <button className="card-button rounded-lg translate-x-[-50%] translate-y-[125%] w-[60%] rounded-[1 rem] border-none bg-btlinks text-white text-[1rem] px-[1rem] py-3 absolute left-[50%] bottom-0 opacity-0 transition-all duration-300 hover:bg-green-700 text-xl">Take up task</button>
        </div>
    </div>
  )
}

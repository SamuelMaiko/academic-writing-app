...
const AssignmentCard = () => {
  ...
  return (
    // 34rem
    <div>
        <div className="card relative w-[100%] h-[23rem] rounded-lg bg-secondary border-2 border-[#c3c6ce] transition-all duration-500  hover:border-btlinks shadow-[0_0_4px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_18px_0_rgba(0,0,0,0.25)]">

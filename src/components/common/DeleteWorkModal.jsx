  ...
  return (
    <div className='relative w-[50rem] h-full'>  
          ...
          <div className='absolute bottom-5 right-5'>
              ...
              <button onClick={handleClose2} className='bg-red-700 hover:shadow-[2px_2px_5px_rgba(0,0,0,0.4)] py-2 px-5 font-opensans text-[1rem] rounded-lg text-white'>Delete</button>
          </div>

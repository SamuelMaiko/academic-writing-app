...
const EditWorkForm = ({handleClose}) => {
  return (
    <form className='relative lg:w-[100%] w-full px-5 text-white'>
      <h1 className='text-center text-4xl font-prompt'>Edit Work</h1>
      <div className='mt-2'>
      ...
      <div className='pb-5'>
          <button onClick={handleClose} className='shadow-[0_0_4px_rgba(0,0,0,0.15)] w-full text-center text-2xl  bg-green-700 hover:bg-btlinks mt-5 text-white rounded-lg py-2 '>Save changes</button>
      </div>

        ...
        <div className=' w-[90%] margin-auto h-full flex lg:static justify-center'>
            <section className='z-[2] h-[28rem] lg:h-fit relative bg-[rgba(245,245,220,0.5)] lg:absolute pt-[4.8rem] md:pt-0 mt-[8.5rem] md:mt-[16rem] lg:mt-0 w-[95%] mx-auto md:w-[48rem] md:bg-transparent flex-wrap lg:flex-nowrap lg:m-0 lg:left-24 bottom-24 lg:top-80  lg:w-[45%]'>
                ...
                <div className="md:ml-20 lg:ml-0">
                    <button className='rounded-3xl lg:hidden px-5 py-3 mt-4 bg-chocolate text-white text-xl hover:bg-green-700'>
                        Login
                    </button>
                    <button onClick={handleCreateAccount} className='md:ml-7 rounded-3xl px-5 py-2 mt-4 border-chocolate border-1 text-chocolate font-semibold text-[1.05rem] hover:shadow-[0_0_5px_rgba(0,0,0,0.2)] hover:border-secondary'>
                        Create account
                    </button>
                </div>
            </section>

            <Div className="absolute   w-[28rem] h-[28rem] right-20 lg:right-24 top-52 lg:top-36 rounded-full p-4  lg:inline-block ">
                
            </Div>
            <Div2 className="absolute left-64 top-10 opacity-[0.2] w-[28rem] h-[28rem] ">

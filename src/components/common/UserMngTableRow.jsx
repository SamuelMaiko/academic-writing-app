  ...
  return (
    <tr className="border-1 h-[3rem] text-lg">
      ...
      <DropdownMenu aria-label="Static Actions">
        <DropdownItem key="new" textValue="user" onClick={handleOpen10}><span className='text-xl'>Edit User Details</span></DropdownItem>
        <DropdownItem key="copy" textValue="user" className={`${U_ROLE=="Admin"? "":"hidden"}`} onClick={handleOpenOptions}><span className='text-xl'>Edit Admin Rights</span></DropdownItem>
...
{/* //////////////////////////////////////// Responsible for the adin rights pop over*/}
        ...
        <Fade in={openOptions}>
          <Box className="absolute p-4 flex justify-center  text-white rounded-lg top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-black w-[32rem] h-[14rem]">
